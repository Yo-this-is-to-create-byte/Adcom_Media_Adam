...
const data = {
  ...
  stories: {
    title: 'Built to be found.<br /><span class="text-white/40">Everywhere it matters.</span>',
    subtitle: 'A handful of recent search engagements. Categories change, the operating model that earns organic demand does not.',
    stories: [
      {
        ...
        approach: 'Rebuilt the site for the distributor journey, then layered technical and on-page SEO, a content engine and lead flows on top of it.',
      ...
      },
      {
        ...
        challenge: 'A trusted local furniture house that was invisible in search, chosen in-store but never found before the visit.',
        approach: 'Rebuilt local and organic search visibility, cleaned site architecture and content so the brand owns intent-led queries in its city.',
